...
public class OneToOneDemo
{
	public static void main(String[] args)
	{
		...
		try { 				
				...
				Instructor tempInstructor = new Instructor("Ronaldo", "Christiano","rchristiano@real.co.sp" );
				InstructorDetail tempInstructorDetail = new InstructorDetail("http://www.youtube.com/Ndumiso", "Loves to dribble" );
